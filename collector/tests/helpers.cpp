...
namespace micro_profiler
{
	...
	void tests::on_enter(calls_collector_thread_mb &collector, const void **stack_ptr, timestamp_t timestamp,
		const void *callee)
	{	collector.on_enter(stack_ptr, timestamp, callee);	}

	const void *tests::on_exit(calls_collector_thread_mb &collector, const void **stack_ptr, timestamp_t timestamp)
	{	return collector.on_exit(stack_ptr, timestamp);	}
