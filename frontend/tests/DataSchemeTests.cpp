	...
	namespace tests
	{
		...
		begin_test_suite( StackIDBuilderTests )
			...
			test( CallstackIndexIsOperable )
			{
				...
				call_statistics data_[] = {
					make_call_statistics(11, 0, 0, 29, 0, 0, 0),
					make_call_statistics(23, 0, 11, 31, 0, 0, 0),
					make_call_statistics(12, 0, 0, 291, 0, 0, 0),
					make_call_statistics(31, 0, 11, 37, 0, 0, 0),
					make_call_statistics(97, 0, 31, 41, 0, 0, 0),
					make_call_statistics(99, 0, 11, 37, 0, 0, 0),
				};
		...
		begin_test_suite( AggregatedRepresentationTests )
			...
			test( ThreadAggregationWorksForPlainCalls )
			{
				// INIT
				call_statistics data_[] = {
					make_call_statistics(1, 0, 0, 29, 10, 901, 0),
					make_call_statistics(2, 0, 0, 31, 11, 911, 0),
					make_call_statistics(3, 0, 0, 39, 15, 931, 0),

					make_call_statistics(4, 1, 0, 29, 03, 763, 0),
					make_call_statistics(5, 1, 0, 31, 07, 765, 0),
					make_call_statistics(6, 1, 0, 37, 90, 769, 0),
				};
				calls_statistics_table tbl;
				...
				call_statistics reference[] = {
					make_call_statistics(1, 0, 0, 29, 13, 1664, 0),
					make_call_statistics(2, 0, 0, 31, 18, 1676, 0),
					make_call_statistics(3, 0, 0, 39, 15, 931, 0),
					make_call_statistics(4, 0, 0, 37, 90, 769, 0),
				};

				assert_equivalent(reference, *aggregated);

				// ACT
				add(tbl, make_call_statistics(16, 70, 0, 37, 10, 100, 3));
				...
				call_statistics reference2[] = {
					...
					make_call_statistics(2, 0, 0, 31, 18, 1676, 0),
					make_call_statistics(3, 0, 0, 39, 15, 931, 0),
					make_call_statistics(4, 0, 0, 37, 100, 869, 3),
				};
			...
			test( ThreadAggregationWorksForNestedCalls )
			{
				// INIT
				call_statistics data_[] = {
					make_call_statistics(10, 7, 00, 29, 10, 901, 0),
					make_call_statistics(20, 7, 10, 31, 11, 911, 0),
					make_call_statistics(30, 7, 00, 39, 15, 931, 0),

					make_call_statistics(40, 7, 10, 29, 03, 763, 0),
					make_call_statistics(50, 7, 20, 31, 07, 765, 0),
					make_call_statistics(60, 7, 30, 37, 90, 769, 0),

					make_call_statistics(91, 1, 00, 29, 100, 1000, 0),
					make_call_statistics(92, 1, 91, 31, 200, 3000, 0),
					make_call_statistics(95, 1, 92, 31, 300, 7000, 0),
				...
				call_statistics reference1[] = {
					make_call_statistics(1, 0, 0, 29, 110, 1901, 0),
					make_call_statistics(2, 0, 1, 31, 211, 3911, 0),
					make_call_statistics(3, 0, 0, 39, 15, 931, 0),
					make_call_statistics(4, 0, 1, 29, 03, 763, 0),
					make_call_statistics(5, 0, 2, 31, 307, 7765, 0),
					make_call_statistics(6, 0, 3, 37, 90, 769, 0),
				};
		...
		begin_test_suite( DataTypesTests )
			test( CallStatisticsPathIsCalculatedUponRetrieval )
			{
				...
				const call_statistics data[] = {
					...
					make_call_statistics(4, 0, 2, 0, 0, 0, 0),
					make_call_statistics(5, 0, 4, 0, 0, 0, 0),
					make_call_statistics(6, 0, 3, 0, 0, 0, 0),
					make_call_statistics(7, 0, 5, 0, 0, 0, 0),
				};
			...
			test( AttemptToGetPathForAMissingParentAbridgesPath )
			{
				// INIT
				const call_statistics data[] = {
					make_call_statistics(1, 0, 10, 0, 0, 0, 0),
					make_call_statistics(2, 0, 1, 0, 0, 0, 0),
					make_call_statistics(3, 0, 2, 0, 0, 0, 0),
				};
				auto lookup = [&] (id_t id) -> const call_statistics * {
			...
			test( NonRecurrentCallsHaveZeroReentranceLevel )
			{
				// INIT
				const call_statistics data[] = {
					make_call_statistics(1, 0, 0, 101, 0, 0, 0),
					make_call_statistics(2, 0, 1, 102, 0, 0, 0),
					make_call_statistics(3, 0, 1, 103, 0, 0, 0),
					make_call_statistics(4, 0, 2, 104, 0, 0, 0),
					make_call_statistics(5, 0, 4, 105, 0, 0, 0),
					make_call_statistics(6, 0, 3, 106, 0, 0, 0),
					make_call_statistics(7, 0, 5, 107, 0, 0, 0),
				};
				auto lookup = [&] (id_t id) {	return id ? &(data[id - 1]) : nullptr;	};
			...
			test( ReentranceLevelIsCalculatedBasedOnTheAddress )
			{
				...
				const call_statistics data[] = {
					make_call_statistics(1, 0, 0, 101, 0, 0, 0),
					make_call_statistics(2, 0, 1, 101, 0, 0, 0),
					make_call_statistics(3, 0, 2, 102, 0, 0, 0),
					make_call_statistics(4, 0, 3, 102, 0, 0, 0),
					make_call_statistics(5, 0, 4, 101, 0, 0, 0),
					make_call_statistics(6, 0, 3, 102, 0, 0, 0),
					make_call_statistics(7, 0, 6, 101, 0, 0, 0),
				};
				auto lookup = [&] (id_t id) {	return id ? &(data[id - 1]) : nullptr;	};
