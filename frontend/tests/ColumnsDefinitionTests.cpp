...
#define assert_comparison_valid(f, d) verify_comparisons((f), (d), ut::LocationInfo(__FILE__, __LINE__))
			...
			test( TimesCalledAreComparedAsExpected )
			{
				...
				call_statistics data[] = {
					make_call_statistics(0, 0, 0, 0, 10, 0, 0, 0, 0),
					make_call_statistics(0, 0, 0, 0, 11, 0, 0, 0, 0),
					make_call_statistics(0, 0, 0, 0, 10000000000, 0, 0, 0, 0),
					make_call_statistics(0, 0, 0, 0, 10000000001, 0, 0, 0, 0),
					make_call_statistics(0, 0, 0, 0, 0xF000000000000000, 0, 0, 0, 0),
				};
			...
			test( InclusiveTimesAreComparedAsExpected )
			{
				// INIT
				call_statistics data[] = {
					make_call_statistics(0, 0, 0, 0, 0, 0, -0x7F00000000000000, 0, 0),
					make_call_statistics(0, 0, 0, 0, 0, 0, -10, 0, 0),
					make_call_statistics(0, 0, 0, 0, 0, 0, 11, 0, 0),
					make_call_statistics(0, 0, 0, 0, 0, 0, 10000000000, 0, 0),
					make_call_statistics(0, 0, 0, 0, 0, 0, 10000000001, 0, 0),
					make_call_statistics(0, 0, 0, 0, 0, 0, 0x7F00000000000000, 0, 0),
				};
			...
			test( ExclusiveTimesAreComparedAsExpected )
			{
				// INIT
				call_statistics data[] = {
					make_call_statistics(0, 0, 0, 0, 0, 0, 0, -0x7F00000000000000, 0),
					make_call_statistics(0, 0, 0, 0, 0, 0, 0, -10, 0),
					make_call_statistics(0, 0, 0, 0, 0, 0, 0, 11, 0),
					make_call_statistics(0, 0, 0, 0, 0, 0, 0, 10000000000, 0),
					make_call_statistics(0, 0, 0, 0, 0, 0, 0, 10000000001, 0),
					make_call_statistics(0, 0, 0, 0, 0, 0, 0, 0x7F00000000000000, 0),
				};
