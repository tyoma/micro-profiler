		...
		begin_test_suite( StatisticsHierarchyAccessTests )
			...
			test( ParentEqualityUsesParentId )
			{
				...
				call_statistics data[] = {
					make_call_statistics(1, 0, 1321, 0, 0, 0, 0, 0, 0),
					make_call_statistics(1, 0, 19, 0, 0, 0, 0, 0, 0),
					make_call_statistics(1, 0, 1321, 0, 0, 0, 0, 0, 0),
				};
			...
			test( TotalOrderUsesPrimaryID )
			{
				...
				call_statistics data[] = {
					make_call_statistics(1, 0, 19, 0, 0, 0, 0, 0, 0),
					make_call_statistics(2, 0, 19, 0, 0, 0, 0, 0, 0),
					make_call_statistics(131, 0, 19, 0, 0, 0, 0, 0, 0),
					make_call_statistics(131, 0, 19, 0, 0, 0, 0, 0, 0),
				};
			...
			test( ItemPathIsReturned )
			{
				...
				call_statistics data[] = {
					...
					make_call_statistics(4, 0, 3, 0, 0, 0, 0, 0, 0),
