		...
		begin_test_suite( AdditiveDeSerializationTests )
			test( DeserializationIntoExistingValuesAddsValuesBase )
			{
				...
				addressed_statistics2 batch1[] = {
					make_statistics(123441u, 17, 123123123, 32123),
					make_statistics(7741u, 1117, 1231123, 3213),
				};
				addressed_statistics2 batch2[] = {
					make_statistics(141u, 17, 11293123, 132123),
					make_statistics(7341u, 21117, 21231123, 23213),
					make_statistics(7741u, 31117, 31231123, 33213),
				};
				...
				addressed_statistics2 reference1[] = {
					make_statistics(141u, 17, 11293123, 132123),
					make_statistics(7341u, 21117, 21231123, 23213),
					make_statistics(7741u, 31117 + 1117, 31231123 + 1231123, 33213 + 3213),
					make_statistics(123441u, 17, 123123123, 32123),
				};
				...
				addressed_statistics2 reference2[] = {
					make_statistics(141u, 2 * 17, 2 * 11293123, 2 * 132123),
					make_statistics(7341u, 2 * 21117, 2 * 21231123, 2 * 23213),
					make_statistics(7741u, 2 * 31117 + 1117, 2 * 31231123 + 1231123, 2 * 33213 + 3213),
					make_statistics(123441u, 17, 123123123, 32123),
				};
		...
		begin_test_suite( FlattenDeSerializationTests )
			...
			test( PlainCallsAreDeserializedFromWithinASingleThread )
			{
				...
				ser(plural + make_pair(13u, plural
					+ make_statistics(1010u, 11, 1002, 32)
					+ make_statistics(1110u, 110, 2002, 12)));
				...
				call_statistics reference1[] = {
					make_call_statistics(1, 13, 0, 1010u, 11, 1002, 32),
					make_call_statistics(2, 13, 0, 1110u, 110, 2002, 12),
				};
				...
				ser(plural + make_pair(17u, plural
					+ make_statistics(1u, 1, 1002, 32)
					+ make_statistics(1010u, 2, 1002, 32)
					+ make_statistics(1110u, 3, 2002, 12)));
				...
				call_statistics reference2[] = {
					...
					make_call_statistics(3, 17, 0, 1u, 1, 1002, 32),
					make_call_statistics(4, 17, 0, 1010u, 2, 1002, 32),
					make_call_statistics(5, 17, 0, 1110u, 3, 2002, 12),
				};
			...
			test( PlainCallsAreDeserializedFromWithinMultipleThreads )
			{
				...
				ser(plural
					...
					+ make_pair(130u, plural
						+ make_statistics(1010u, 9, 1002, 32))
					+ make_pair(131u, plural
						+ make_statistics(7u, 1, 10, 11)));
				...
				call_statistics reference[] = {
					make_call_statistics(1, 13, 0, 1010u, 11, 1002, 32),
					make_call_statistics(2, 13, 0, 1110u, 110, 2002, 12),
					make_call_statistics(3, 130, 0, 1010u, 9, 1002, 32),
					make_call_statistics(4, 131, 0, 7u, 1, 10, 11),
				};
			...
			test( PlainCallsAreAccumulatedOnDeserialization )
			{
				...
				ser(plural
					+ make_pair(7u, plural
						+ make_statistics(1u, 1, 100, 32)
						+ make_statistics(2u, 1, 101, 12)
						+ make_statistics(3u, 1, 102, 32)
						+ make_statistics(5u, 2, 103, 11)));
				dser(idx, scontext::root_context(ctx, idx));
				ser(plural
					+ make_pair(7u, plural
						+ make_statistics(9u, 1, 102, 32)
						+ make_statistics(1u, 10, 10, 2)
						+ make_statistics(2u, 10, 11, 2)
						+ make_statistics(5u, 20, 13, 1)));
				...
				// ASSERT
				call_statistics reference[] = {
					make_call_statistics(1, 7, 0, 1, 11, 110, 34),
					make_call_statistics(2, 7, 0, 2, 11, 112, 14),
					make_call_statistics(3, 7, 0, 3, 1, 102, 32),
					make_call_statistics(4, 7, 0, 5, 22, 116, 12),
					make_call_statistics(5, 7, 0, 9, 1, 102, 32),
				};
			...
			test( HierarchicalCallsAreDeserializedFromWithinASingleThread )
			{
				...
				ser(plural
					+ make_pair(7u, plural
						+ make_statistics(1u, 1, 100, 32, plural
							+ make_statistics(2u, 1, 101, 12))
						+ make_statistics(3u, 1, 102, 32, plural
							+ make_statistics(5u, 2, 103, 11)
							+ make_statistics(9u, 1, 102, 32)
							+ make_statistics(1u, 10, 10, 2))
						+ make_statistics(2u, 10, 11, 2, plural
							+ make_statistics(5u, 20, 13, 1)
							+ make_statistics(9u, 1, 1, 1))));
				...
				// ASSERT
				call_statistics reference[] = {
					make_call_statistics(0, 7, 0, 1u, 1, 100, 32),
					make_call_statistics(0, 7, 1, 2u, 1, 101, 12),
					make_call_statistics(0, 7, 0, 3u, 1, 102, 32),
					make_call_statistics(0, 7, 3, 5u, 2, 103, 11),
					make_call_statistics(0, 7, 3, 9u, 1, 102, 32),
					make_call_statistics(0, 7, 3, 1u, 10, 10, 2),
					make_call_statistics(0, 7, 0, 2u, 10, 11, 2),
					make_call_statistics(0, 7, 7, 5u, 20, 13, 1),
					make_call_statistics(0, 7, 7, 9u, 1, 1, 1),
				};
