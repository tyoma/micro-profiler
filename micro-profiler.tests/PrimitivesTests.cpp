	...
	namespace tests
	{
		...
		public:
			...
			void DetailedStatisticsAddChildCallFollowsAddCallRules()
			{
				...
				Assert::IsTrue(2 == s1.children_statistics[(void *)1].max_call_time);
				...
				Assert::IsTrue(3 == s1.children_statistics[(void *)2].max_call_time);
				...
				Assert::IsTrue(5 == s1.children_statistics[(void *)3].max_call_time);
				...
				Assert::IsTrue(6 == s2.children_statistics[(void *)20].max_call_time);
				...
				Assert::IsTrue(7 == s2.children_statistics[(void *)30].max_call_time);
			}
		};
	}
}