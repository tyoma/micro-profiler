...
namespace strmd
{
	...
	template <typename StreamT, typename PackerT, int static_version, typename RepT, typename RatioT>
	inline void serialize(deserializer<StreamT, PackerT, static_version> &archive, mt::duration<RepT, RatioT> &data)
	{
		RepT v;
