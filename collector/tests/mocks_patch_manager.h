	...
	namespace tests
	{
		namespace mocks
		{
			...
			public:
				...
				std::function<void (patch_change_results &results, id_t module_id, request_range targets)> on_apply;
				std::function<void (patch_change_results &results, id_t module_id, request_range targets)> on_revert;
			...
			inline void patch_manager::apply(patch_change_results &results, id_t module_id, request_range targets)
			{	on_apply(results, module_id, targets);	}

			inline void patch_manager::revert(patch_change_results &results, id_t module_id, request_range targets)
